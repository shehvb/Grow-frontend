...
import type { SubjectProgress, Stat } from "../types/index (2)";
...
export const SectionHeader: FC<SectionHeaderProps> = ({ label, title, sub, dark = false }) => (
  <>
    <FadeUp>
      <p className={`text-center font-black text-xs uppercase tracking-widest mb-3 ${dark ? "text-blue-300" : "text-blue-600"}`}>
        {label}
      </p>
    </FadeUp>
    <FadeUp delay={80}>
