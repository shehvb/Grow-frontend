...
import { PROGRESS_BARS } from "../data";
  ...
  <section className="pt-36 pb-20 px-8 md:px-16 max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center relative">
    ...
    <div className="animate-fade-up">
      ...
      <div className="flex gap-4 flex-wrap">
        <button className="px-8 py-4 rounded-2xl bg-blue-600 text-white font-black text-base shadow-xl shadow-blue-200 hover:-translate-y-1 hover:shadow-blue-300 transition-all">
          Get Started
        </button>
        <button className="px-8 py-4 rounded-2xl bg-orange-400 text-white font-black text-base shadow-xl shadow-orange-200 hover:-translate-y-1 transition-all">
          Sign Up Free
        </button>
      </div>
    </div>
