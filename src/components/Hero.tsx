    ...
    <section className="pt-36 pb-20 px-6 md:px-12 max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 items-center relative">
      ...
      <div className="animate-fade-up">
        ...
        <p className="text-slate-500 text-base leading-relaxed mb-8 max-w-md">
          A centralized platform where schools manage education, teachers create and manage learning content, students track their progress, and parents stay informed in real time.
        </p>

        <div className="flex gap-4 flex-wrap">
          <button onClick={() => navigate('/signup/student')} className="px-8 py-4 rounded-2xl bg-blue-600 text-white font-black text-base shadow-xl shadow-blue-200 hover:-translate-y-1 hover:shadow-blue-300 transition-all">
            Get Started &gt;
          </button>
        </div>
      </div>
