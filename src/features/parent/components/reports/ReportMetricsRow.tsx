  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      ...
      <div className="bg-white rounded-[28px] p-8 shadow-[0_4px_20px_0_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col justify-between relative overflow-hidden h-[180px]">
        <div className="absolute -top-6 -right-6 w-24 h-24 bg-[#1600D5]/5 rounded-bl-[48px] flex items-center justify-center pt-4 pl-4 transition-transform group-hover:scale-110">
            <FiClock className="text-[#1600D5] w-6 h-6" />
        </div>
        <div>
        ...
        <div className="mt-4 flex items-center">
          <span className="bg-[#E1EFFF] text-[#1600D5] text-[12px] font-black px-2 py-0.5 rounded-md">
      ...
      {/* Assignments */}
      <div className="bg-white rounded-[28px] p-8 shadow-[0_4px_20px_0_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col justify-between relative overflow-hidden h-[180px]">
        <div className="absolute -top-6 -right-6 w-24 h-24 bg-[#FF8000]/5 rounded-bl-[48px] flex items-center justify-center pt-4 pl-4">
            <FiFileText className="text-[#FF8000] w-6 h-6" />
        </div>
        <div>
        ...
        <div className="flex items-center gap-2 mt-4 text-[#FF8000] font-extrabold text-[13px] tracking-tight">
      ...
      {/* Attendance */}
      <div className="bg-white rounded-[28px] p-8 shadow-[0_4px_20px_0_rgba(0,0,0,0.03)] border border-slate-100 flex flex-col justify-between relative overflow-hidden h-[180px]">
        <div className="absolute -top-6 -right-6 w-24 h-24 bg-[#FF00D5]/5 rounded-bl-[48px] flex items-center justify-center pt-4 pl-4">
            <FiCalendar className="text-[#FF00D5] w-6 h-6" />
        </div>
        <div>
