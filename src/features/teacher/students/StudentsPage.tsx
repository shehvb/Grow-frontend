    ...
    <div className="space-y-8 animate-fade-in pb-10">
      ...
      <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="relative w-full md:w-64 shrink-0">
          <select className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold text-slate-800 focus:border-orange-400 outline-none transition-all appearance-none cursor-pointer hover:bg-slate-100">
