    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {/* Create Course button — icon rotates 90° on hover */}
          <motion.button
          ...
          <AnimatePresence>
            {courses.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="mb-8 flex-1">
                      <h3 className="text-2xl font-black text-slate-800 mb-2">
                        {course.title || "Algebra Fundamentals"}
                      </h3>
                      <p className="text-sm text-slate-400 font-medium leading-relaxed max-w-[90%]">
                        {course.description ||
                          "Master the basics of algebraic expressions and equations"}
                      </p>
                    </div>
              ...
              <motion.div
                key="empty"
                variants={cardVariants}
                className="col-span-full bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-12 text-center space-y-4"
              >
